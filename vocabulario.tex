...
\item die Herausforderung: desafío
...
\item die Wahl: elección
\item die Werbung: publicidad
\item die Wirkin: el efecto
...
\item mittendrin: justo en el centro
\item nach rechts: hacia la derecha
\item oben: arriba
\item out: afuera
\item rechts: derecha
\item unten: debajo
\item voraus: frente/delante
\item vorn: delante
\item zentrum: centro
\end{myitemize}
...
\item die Tür: puerta
\item die Umbauarbeiten: Obras de remodelación
\item die Uhr: reloj
...
\item der Biergarten: cervecería al aire libre
...
\item eher: más
\item jedenfalls: en cualquier caso
\item obwohl: aunque
\item oder: o
\item seither: desde entonces
\item sobald: tan pronto como
\item später: más tarde
\item trotz: a pesar de
\item troztdem: sin embargo
\item und: y
\item wegen: debido a
\item weshalb: la razón por la cual
\item wieso: por qué
...
\item der Wetterbericht: boletín meteorológico
...
\item der Betriebsrat: comité de la empresa
...
\item der eingetragener Verein (e.V.): asociación registrada
...
\item die Gewerkschaft: sindicato
...
\item die Versammlung: asamblea
\item die Vorstellung: presentación
