...
El verbo más importante a saber conjugar es \textbf{werden}: A partir de este verbo, se puede formar el KII de otros verbos, utilizando werden en KII y el verbo en infinitivo. En general, el Konjunktiv II se forma igual que el Präteritum, pero agregando umlaut sobre la vocal: h\textbf{a}tte $\Rightarrow$ h\textbf{ä}tte
